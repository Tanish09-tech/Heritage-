...
export const DICTIONARY = {
  en: {
    ...
    guruShishyaDetails: 'Guru & Shishya Details',
  ...
  hi: {
    ...
    guruShishyaDetails: 'गुरु और शिष्य विवरण',
  ...
  mr: {
    ...
    guruShishyaDetails: 'गुरु आणि शिष्य तपशील',
  ...
  pa: {
    ...
    guruShishyaDetails: 'ਗੁਰੂ ਅਤੇ ਸ਼ਿਸ਼ ਵੇਰਵੇ',
  ...
  gu: {
    ...
    guruShishyaDetails: 'ગુરુ અને શિષ્ય વિગતો',
  ...
  as: {
    ...
    guruShishyaDetails: 'গুৰু আৰু শিষ্যৰ বিৱৰণ',
  ...
  ml: {
    ...
    guruShishyaDetails: 'ഗുരു, ശിഷ്യ വിവരങ്ങൾ',
