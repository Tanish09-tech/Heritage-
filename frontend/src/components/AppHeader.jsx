...
export default function AppHeader({ 
  ...
  const getScreensForRole = () => {
    ...
    if (currentRole === 'PRACTITIONER') {
      return [
        ...
        { id: 'AI_ANALYSIS', label: '7. AI Early Warning System' },
    ...
    return [
      ...
      { id: 'DOCUMENTATION', label: '6. Knowledge Documentation Vault' },
      { id: 'AI_ANALYSIS', label: '7. AI Early Warning System' },
      { id: 'RECOMMENDATIONS', label: '8. Platform Recommendations' },
      { id: 'SETTINGS', label: '9. Platform Settings' },
    ];
  };
  ...
  const getTitle = () => {
    switch (activeView) {
      ...
      case 'GURU_SHISHYA_DETAILS': return 'Guru & Shishya Details';
